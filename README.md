...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [AiPillar](https://github.com/AiPillar) open-source ecosystem.
...
The `dashboard` application is the web frontend for AiPillar, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/AiPillar/dashboard
cd dashboard
npm install
```
